...
public class Reservation implements Serializable {
    ...
    public Reservation(Passenger bookedPassengers) {  
        ReservationID = selfIncrementingCode();
    ...
    public void setReservationID() {
        this.ReservationID = selfIncrementingCode();
    }
    ...
    private String selfIncrementingCode() {
        uniqueCode += 1;
        String result = String.format( "%07d",uniqueCode); // take import code as 7 digit  0000001,..
